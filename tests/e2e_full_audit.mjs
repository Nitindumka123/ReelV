/**
 * ReelVault End-to-End Test Suite for Phase 8 Verification
 * Tests:
 * 1. Health & Readiness Probes
 * 2. Input Validation & SSRF Prevention
 * 3. Media Resolution via yt-dlp / Extractor
 * 4. Secure Download Token Generation & Validation
 * 5. Download Streaming & Headers (including nosniff, cache-control, content-disposition, X-Robots-Tag)
 * 6. Error states (invalid, unsupported, malicious, non-existent, private)
